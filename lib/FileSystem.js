...
export class FileSystem {
   ...
   * it appears reactNativeFetchBlob will flag these files to persist behind the scenes, so cache dir is safe on apple. See: https://www.npmjs.com/package/react-native-blob-util#cache-file-management
   *
   * Android:
  ...
  /**
   *
   * Wrapper for https://github.com/joltup/react-native-blob-util/wiki/File-System-Access-API#existspathstringpromise
   *
